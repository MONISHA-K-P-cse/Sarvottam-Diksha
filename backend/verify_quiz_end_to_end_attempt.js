...
(async () => {
  ...
  console.log('2. Selecting Option A...');
  await page.click('button:has-text("A"), div:has-text("A")');
  ...
  console.log('\n=================== VERIFICATION: END-TO-END TEST ATTEMPT ===================');
  console.log('Final URL:', page.url());
  console.log('Reached Result Page:', page.url().includes('test-result'));
  console.log('Performance Breakdown Visible:', resultText.includes('Score') || resultText.includes('PASSED') || resultText.includes('Accuracy') || resultText.includes('Analytics'));
  console.log('=============================================================================\n');

...
// Copy Class 10 to Class 7 and Class 6 as fallback for PARIKSHA
if (fs.existsSync(path.join(destDir, 'pariksha-10.png'))) {
  fs.copyFileSync(path.join(destDir, 'pariksha-10.png'), path.join(destDir, 'pariksha-7.png'));
  fs.copyFileSync(path.join(destDir, 'pariksha-10.png'), path.join(destDir, 'pariksha-6.png'));
  console.log(`Copied pariksha-10.png to pariksha-7.png and pariksha-6.png`);
}

console.log('Successfully copied all official PARIKSHA image templates to frontend/public/courses!');
